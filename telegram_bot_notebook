...
def menu(update, context):
    ...
    context.bot.send_message(chat_id=chat.id, text="""
     - for creating a note tap on the button 😁👉 "/make_a_note",
     \n - for viewing notes tap on the button 😸👉 "/check_my_notes",
     \n - for deleting a note tap on the button 😈👉 "/delete_the_note",
     \n - for viewing this menu tap on the button 😉👉 "/menu"
     """)
#_________________________________________________________________________________________
...
def second_deleter(update, context):
    ...
    well done!👍""")
            ...
            context.bot.send_message(chat_id=chat.id, text="""
            there is not such number of note😅""")
    return ConversationHandler.END
